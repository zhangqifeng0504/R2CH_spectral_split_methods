...
M = 24; N = 5000; xa = 0; xb = 20; tb = 20; A = 0; mu = 0; Omega = 0;
% M = 20; N = 4000; xa = 0; xb = 20; tb = 20; A = 1; mu = 1; Omega = 73e-6;  
...
%% Hamiltonian画图
[u1,rho1] = R2CH_SinglePeak1(M,N,xa,xb,tb,A,mu,Omega);
[u2,rho2] = R2CH_SinglePeak2(M,N,xa,xb,tb,A,mu,Omega);
...
legend({'\textbf{Scheme 3}','\textbf{Scheme 4}'},'interpreter','latex','FontSize',14,'FontName','Times','location','Northwest'); 
...
xlabel('$\textbf{t}$','FontUnits','points','interpreter','latex','FontSize',20,'FontName','Times');
ylabel('$\textbf{Error}$','FontUnits','points','interpreter','latex','FontSize',20,'FontName','Times');
legend({'\textbf{Scheme 4}'},'interpreter','latex','FontSize',14,'FontName','Times','location','Northwest'); 